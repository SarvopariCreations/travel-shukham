...
import { ChangeActivityModalComponent } from './change-activity-modal/change-activity-modal.component';
...
@Component({
  ...
  standalone: true,
  imports: [HeaderComponent, AddCityModalComponent, ChangeTransferModalComponent, CommonModule, ChangeHotelModalComponent, ChangeFlightModalComponent, RouterModule, ChangeActivityModalComponent],
  templateUrl: './customize-view.component.html',
  styleUrl: './customize-view.component.scss',
